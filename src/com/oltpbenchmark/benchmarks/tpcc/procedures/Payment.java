...
public class Payment extends TPCCProcedure {
    ...
    public SQLStmt payGetWhseSQL = new SQLStmt(
            "SELECT W_STREET_1, W_STREET_2, W_CITY, W_STATE, W_ZIP, W_NATIONKEY, W_NAME" +
    ...
    public SQLStmt payGetDistSQL = new SQLStmt(
            "SELECT D_STREET_1, D_STREET_2, D_CITY, D_STATE, D_ZIP, D_NATIONKEY, D_NAME" +
    ...
    public SQLStmt payGetCustSQL = new SQLStmt(
            ...
            "       C_CITY, C_STATE, C_ZIP, C_NATIONKEY, C_PHONE, C_CREDIT, C_CREDIT_LIM, " +
    ...
    public SQLStmt customerByNameSQL = new SQLStmt(
            ...
            "       C_STATE, C_ZIP, C_NATIONKEY, C_PHONE, C_CREDIT, C_CREDIT_LIM, C_DISCOUNT, " +
    ...
    public ResultSet run(Connection conn, Random gen,
        ...
        d_nationkey = rs.getInt("D_NATIONKEY");
        ...
        if (LOG.isTraceEnabled()) {
            ...
            terminalMessage.append("  Nation: ");
            terminalMessage.append(w_nationkey);
            terminalMessage.append("\n\n District:  ");
            ...
            terminalMessage.append("  Nation: ");
            terminalMessage.append(d_nationkey);
            terminalMessage.append("\n\n Customer:  ");
            ...
            terminalMessage.append("  Nation: ");
            terminalMessage.append(c.c_nationkey);
            terminalMessage.append("\n   Since:   ");
            if (c.c_since != null) {
